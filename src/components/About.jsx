            ...
            <div className="container about-container">
                ...
                <div className="about-text">
                    ...
                    <div className="about-description">
                        ...
                        <p>
                            I am a versatile mechanical engineer (B.Tech) with a career defined by technical precision and creative expression. My professional journey includes experience as an Asst. Production Engineer at Kondody Autocraft and Management Trainee at Popular Vehicles and Services.
                        </p>
                        <p>
